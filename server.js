...
Maximum:
10 AI sensitivity generations per IP/hour.
    ...
    */
    ...
    if (!rate.allowed) {
      ...
      return res.status(429).json({
        ...
        error:
          "Many users are trying to use AI right now. Please come back later, or generate without AI.",
...
- If the user chooses "Keep current DPI", do not force a DPI change.
